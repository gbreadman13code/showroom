...
const Footer = () => {
  return (
    <footer className={styles.footer}>
      ...
      <p className={styles.head_of_footer}>АНО «Сибирский институт развития креативных индустрий»</p>
      ...
      <div className={styles.footer_info}>
        <div className={styles.middle_of_header}>
          <ul className={styles.contacts}>
            ...
            <li>
              <img src={Mail} alt='mail' /> <a href='mailto:place@industry.art'>place@industry.art</a>
            </li>
