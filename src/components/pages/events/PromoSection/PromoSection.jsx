        ...
        <Container>
          <div className={isMobile ? `${styles.container} ${styles.container__mobile}` : styles.container}>
            ...
            <div className={isMobile ? `${styles.info} ${styles.info__mobile}` : styles.info}>
              <p className={isMobile ? `${styles.dates} ${styles.dates__mobile}` : styles.dates}>{promoDates}</p>
              <p className={isMobile ? `${styles.city} ${styles.city__mobile}` : styles.city}>{promoCity}</p>
              <p className={isMobile ? `${styles.place} ${styles.place__mobile}` : styles.place}>{promoPlace}</p>
              {registrationLink && (
                <a
