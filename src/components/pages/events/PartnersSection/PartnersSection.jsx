...
const PartnersSection = () => {
  ...
  return (
    <div className={isMobile ? `${styles.partners} ${styles.partners__mobile}` : styles.partners}>
      <Container>
        <h2 className={isMobile ? `${styles.title} ${styles.title__mobile}` : styles.title}>Сеть партнёров</h2>
        <NavBar categories={categories} activeCategory={activeCategory} onClickCallback={setActiveCategory} />
