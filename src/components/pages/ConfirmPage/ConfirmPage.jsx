          ...
          {answer && (
            <>
              <div style={!isMobile ? { padding: '0 300px' } : undefined } className={styles.answer_wrapper}>
                ...
                <p>Забрать работу вы сможете по завершении выставки после 18 ноября по адресу Красной Армии 10/3, офис 302. </p>
                <p>Уточнить нюансы можно, написав на почту <a href="mailto:place@industry.art" style={{color: 'inherit'}}>place@industry.art</a> </p>
